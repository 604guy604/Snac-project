...
export function buildSensorInput({
  ...
  const inferredWet    = isWet ?? inferIsWet({ substrate: substrateVal, weatherCode: weatherVal, nearWater });
  ...
  return {
    ...
    near_water:   field(nearWater,     SOURCE.USER,     nearWater !== null   ? CONFIDENCE.HIGH   : CONFIDENCE.NONE),
    on_ridge:     field(onRidge,       SOURCE.USER,     onRidge !== null     ? CONFIDENCE.HIGH   : CONFIDENCE.NONE),
